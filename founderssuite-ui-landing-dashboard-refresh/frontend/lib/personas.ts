// AI simulation personas — ported from founderssuite-feature-sanjay
...
export const SIMULATION_PERSONAS: AIAgent[] = [
  {
    ...
    matchScore: 94, surveysCompleted: 12, lastActive: "2h ago", status: "available", color: "#ffd166", autonomousEnabled: true,
  ...
  },
  {
    ...
    matchScore: 87, surveysCompleted: 8, lastActive: "5h ago", status: "in_survey", color: "#b063ff", autonomousEnabled: false,
  ...
  },
  {
    ...
    matchScore: 76, surveysCompleted: 24, lastActive: "1d ago", status: "available", color: "#7c3aed", autonomousEnabled: true,
  ...
  },
  {
    ...
    matchScore: 91, surveysCompleted: 17, lastActive: "30m ago", status: "available", color: "#ffd166", autonomousEnabled: true,
  ...
  },
  {
    ...
    matchScore: 82, surveysCompleted: 6, lastActive: "3h ago", status: "idle", color: "#ff6b6b", autonomousEnabled: false,
  ...
  },
  {
    ...
    matchScore: 68, surveysCompleted: 31, lastActive: "2d ago", status: "available", color: "#06b6d4", autonomousEnabled: true,
