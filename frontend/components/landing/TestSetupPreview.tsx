            ...
            <div
              className={`absolute inset-0 flex flex-col items-center justify-center transition-all ${dur} ${ease} ${
                phase === "cards"
                  ...
                  : phase === "fuse"
                    ? "opacity-0 scale-[0.92] blur-[4px] translate-y-3 pointer-events-none"
                    : "opacity-0 scale-[0.97] pointer-events-none"
              }`}
            >
              <div className="relative mx-auto flex w-full max-w-[360px] flex-col items-center justify-center pb-0 min-h-[220px]">
                {/* Founder (lavender, behind) */}
                <div
                  className="relative z-0 w-full max-w-[270px] rotate-[-2deg] rounded-xl border border-[#c4b5fd]/60 bg-[#ded4f2] p-3 text-[#2d1b4e] shadow-md"
                >
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-[#f2a58e] to-[#e8c9a0] text-[#1a0b2e] font-bold text-xs ring-1 ring-white/80">
                      MR
                    </div>
                  ...
                  <dl className="mt-2 grid grid-cols-3 gap-1.5 text-center text-[9px] uppercase tracking-wider text-[#584566]">
                    ...
                    <div className="rounded-md bg-white/50 py-1.5">
                      <dt>Interest</dt>
                      <dd className="mt-0.5 text-[10px] font-bold leading-tight text-[#1a0b2e]">{domain}</dd>
                    </div>
                  </dl>
                </div>
                ...
                {/* Tester (dark, front) */}
                <div
                  className="relative z-10 -mt-3 w-full max-w-[300px] rotate-[1deg] rounded-xl border border-[#2a2a2a] bg-[#14101c] p-3 shadow-[0_16px_40px_rgba(0,0,0,0.5)]"
                >
                  ...
                  <div className="mt-2 flex items-start gap-2">
                    <div className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#3d1454] text-white font-bold text-xs ring-2 ring-[#8b5cf6] shadow-[0_0_16px_rgba(139,92,246,0.4)]">
                      JD
                    </div>
