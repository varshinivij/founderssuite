    ...
    <section id="validation" className="relative scroll-mt-32 overflow-x-hidden">
      <div className="mx-auto max-w-[1100px] px-6 py-16 md:py-24">
        <div className="mx-auto mb-10 max-w-[640px] text-center">
          <div className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-violet-500">Validation types</div>
          <h2 className="text-[2rem] font-extrabold leading-tight tracking-tight text-slate-900 md:text-[2.4rem]">
            From problem discovery to beta testing
          </h2>
          <p className="mx-auto mt-3 max-w-[480px] text-base text-slate-500">
            Run structured validation at every stage — hypotheses, prototypes, or live builds.
          </p>
        </div>
        <div className="mx-auto max-w-[800px]">
          ...
          <div className="relative mt-8 overflow-hidden rounded-2xl border border-violet-200/90 bg-gradient-to-b from-violet-50/50 via-white to-white shadow-[0_16px_48px_rgba(91,33,182,0.15)] ring-1 ring-violet-500/12">
            {toast ? (
              <div className="absolute right-4 top-4 z-20 rounded-full border border-violet-300 bg-violet-100 px-4 py-1.5 text-xs font-semibold text-violet-950 shadow-lg shadow-violet-500/20">
                {toast}
              </div>
            ) : null}
